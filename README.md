...
If you're unsure whether something belongs here — it does.  
...
3. **Operating system**
4. **Codex installation method** (`brew` or `npm`)
5. **Binary path** you entered in plugin settings (if relevant)
6. Step-by-step instructions to reproduce the issue
7. Screenshots or terminal output (optional but very helpful)

The more detail you include, the quicker we can investigate and fix the issue.
...
- How you imagine it should behave  
- Any examples or inspirations (optional)
